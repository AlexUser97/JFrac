...
BEGIN {
    ...
    require '/mnt/c/Users/user1/Desktop/src/openssl-3.3.0/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/mnt/c/Users/user1/Desktop/src/openssl-3.3.0/test/fips-and-base.cnf';
    shift;
